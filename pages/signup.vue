                        ...
                        <div class="main">
                          ...
                          <section class="signup">
                              <div class="container">
                                  ...
                                  <div class="signup-content respons">
                                    <div class="signup-image">
                                      ...
                                      <div class="signup-form">
                                          ...
                                          <form @submit.prevent="onSubmit" class="register-form sigin-pg" id="register-form">
                                              <div class="form-group">
                                                  ...
                                                  <b-form-input
                                                    ...
                                                    class="form-control-rounded sin-put"
                                                    type="text"
                                                  ...
                                                  <b-tooltip
                                                    ...
                                                    placement="bottom"
                                                    variant="danger"
                                                    >{{ errors.first("first_name") }}</b-tooltip
                                                  >
                                              </div>
                                              <div class="form-group">
                                                  <label for="name"><i class="zmdi zmdi-account material-icons-name"></i></label>
                                                  ...
                                                  <b-tooltip
                                                    ...
                                                    placement="bottom"
                                                    variant="danger"
                                                    >{{ errors.first("last_name") }}</b-tooltip
                                                  >
                                              </div>
                                              <div class="form-group">
                                              ...
                                              <div class="form-group">
                                                  ...
                                                  <b-form-input
                                                    ...
                                                    class="form-control form-control-rounded sin-put"
                                                    label="Name"
                                                    type="password"
                                              ...
                                              <div class="form-group">
                                                  <input  v-validate="'required'" v-model="data.agree_terms" type="checkbox" name="agree-term" id="agree-term" class="agree-term" />
                                                  <label for="agree-term" class="label-agree-term"><span><span></span></span>I agree all statements in  <a href="/terms-conditions" class="term-service">Terms of service</a></label>
                                              </div>
                                              <div class="form-group form-button">
                                                  <input type="submit" name="signup" id="signup" class="form-submit register" value="Register"/>
                                              </div>
                                          </form>
                                      </div>
    ...
    onSubmit() {
      this.$validator.validate().then(async (result) => {
        if (result) {
          this.$api
            ...
            .then(({ data }) => {
              if(data){
                ...
                this.$bvToast.toast("Account created succssfully and redirecting", {
                ...
                const vm = this;
                setTimeout(function(){ vm.$router.push("/"); }, 1500, vm);
              }
            })
            .catch((err) => {
          ...
          this.$bvToast.toast(`Provided data is not valid or agree to Terms`, {
            title: "AA Travel & Tourism!",
            variant: "danger",
            toaster: "b-toaster-top-center",
            solid: true,
