            ...
            <div class="row">
              ...
              <div class="col-12 pl-1">
                <div class="d-flex w-100 justify-content-end">
                  <div v-if="mailBoxOpen" class="position-fixed w-100 h-100" style="top:0;left: 0" @click="mailBoxOpen=false">
                  </div>
                  <div class="pr-0 position-relative">
                    ...
                    <button
                      type="submit"
                      class="border rounded-circle send-btn position-absolute mr-1" style="right: 0;top: 50%;transform: translateY(-50%);"
