            ...
            <div class="fare-summ">
              ...
              <div class="total">
                ...
                <div class="price-section">
                  ...
                  <div>
                    <span>
                      <small>C$</small> {{PakageDetails.price*data.length}}
                      <!-- <sup>.29</sup> -->
                    </span>
                  </div>
                </div>
        ...
        <div style="background: white; padding: 20px">
          <h5 class="pb-4" v-if="bookedPakage">
            ...
            <p>
              ...
              Been Received AA travels and tourism Will Contact You Shorlty.
            </p>
          </h5>
        </div>
      </div>
        ...
        this.$validator.validate().then((result) => {
          if (result) {
            ...
            this.$root.$bvToast.toast("Provided data is not valid", {
              title: "AA TourAA Travel & Tourismism!",
              variant: "danger",
              solid: true,
              toaster: "b-toaster-top-center",
            });
